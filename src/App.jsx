...
function agregarPorGrupo(notas) {
  const groups = {};
  notas.forEach((n) => {
    const key = `${n.parceiro}||${n.tipo_operacao}||${n.competencia}||${n.semana}`;
    if (!groups[key]) {
      groups[key] = {
        parceiro: n.parceiro,
...
export default function App() {
  ...
  }, [gruposFiltrados, filtroGranularidade]);
      ...
      {dataReady && (
        <>
          ...
          <div style={{ marginTop: 8, fontSize: 12, color: C.cinzaTexto, lineHeight: 1.6 }}>
            ...
            Rentabilidade = Receita ÷ Custo. O parça é identificado pela coluna nome_armazem, padronizado como
